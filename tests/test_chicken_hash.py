...
def test_chicken_hash():
    ...
    expected_hash_hex = b"6658e0663e280e1cfdd446107c415f085984c3550f6c3d0a2016a9d5391377d9"
    ...
    assert computed_hash_hex == expected_hash_hex, f"Expected hash {expected_hash_hex}, but got {computed_hash_hex}"
